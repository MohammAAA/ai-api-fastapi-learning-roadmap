...
async def get_ai_response(conversation_json: str) -> str:
    """Call OpenAI API."""
    try:
        response = await client_gemini.aio.models.generate_content(model="gemini-2.5-flash", contents=conversation_json)
